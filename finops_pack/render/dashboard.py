...
def _build_executive_summary(account_map: list[AccountMapEntry]) -> str:
...
def render_dashboard_html(
    ...
    *,
    ...
    return template.render(
        ...
        region=region,
        executive_summary=_build_executive_summary(account_map),
        account_map={
            "entries": account_map,
            "prod": grouped["prod"],
...
def write_dashboard(
    ...
    *,
    ...
    destination_path.write_text(
        render_dashboard_html(account_map, account_id=account_id, region=region),
        encoding="utf-8",
    )
