...
import finops_pack.integrations.aws.cost_explorer as cost_explorer
...
def test_build_resource_daily_request_kwargs_includes_required_filter_and_grouping() -> None:
    request_kwargs = build_resource_daily_request_kwargs(
        time_period={"Start": "2026-03-10", "End": "2026-03-24"}
    )
