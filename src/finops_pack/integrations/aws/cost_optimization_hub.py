...
from finops_pack.domain.models import NormalizedRecommendation, Recommendation, SavingsRange
...
DEFAULT_SUMMARY_GROUP_BY = "ResourceType"
...
def list_recommendation_summaries(
    ...
    *,
    ...
    resolved_group_by = group_by or DEFAULT_SUMMARY_GROUP_BY
    request_kwargs: dict[str, object] = {"groupBy": resolved_group_by}
    ...
    returned_group_by: str | None = resolved_group_by
    ...
    for page in pages:
        ...
        if isinstance(page.get("groupBy"), str):
            returned_group_by = page["groupBy"]
